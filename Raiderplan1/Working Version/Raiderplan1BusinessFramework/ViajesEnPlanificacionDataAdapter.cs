...
//               File: ViajesEnPlanificacionDataAdapter
...
namespace Raiderplan1 {
   ...
   public partial class ViajesEnPlanificacionDataAdapter : System.Data.IDataAdapter, IViajesEnPlanificacionDataAdapter
   {
      private ViajesEnPlanificacionDataSet ViajesEnPlanificacionSet ;
      public ViajesEnPlanificacionDataAdapter( )
      {
      ...
      ///  <summary>
      ///   Gets or sets the Transaction object to be used  by  ViajesEnPlanificacionDataAdapterclasses
      ...
      public virtual int Fill( ViajesEnPlanificacionDataSet dataSet ,
                               int usuarioID )
      {
         this.Initialize( ) ;
         connDefault = dsDefault.GetReadWriteConnection( daCurrentTransaction) ;
         ViajesEnPlanificacionSet = dataSet ;
      ...
      public virtual int FillPage( ViajesEnPlanificacionDataSet dataSet ,
                                   int usuarioID ,
                                   int startRow ,
                                   int maxRows )
      {
      ...
      private int GetInternalRecordCount( int usuarioID )
      {
         ...
         m_WhereString = " WHERE (@UsuarioID = [UsuarioID]) AND ([ViajeEstado] = 'A')" ;
      ...
      {
         ViajesEnPlanificacionSet = dataSet as ViajesEnPlanificacionDataSet ;
         if ( ( ViajesEnPlanificacionSet != null ) )
         {
            return Fill( ViajesEnPlanificacionSet) ;
         }
         else
         {
            ViajesEnPlanificacionSet = new ViajesEnPlanificacionDataSet() ;
            Fill( ViajesEnPlanificacionSet) ;
            dataSet.Merge( ViajesEnPlanificacionSet) ;
            return 0 ;
         }
      }
                                   ...
                                   int maxRows )
      {
         ...
         if ( ( ViajesEnPlanificacionSet != null ) )
         {
            return FillPage( ViajesEnPlanificacionSet, startRow, maxRows) ;
         }
         else
         {
            ViajesEnPlanificacionSet = new ViajesEnPlanificacionDataSet() ;
            FillPage( ViajesEnPlanificacionSet, startRow, maxRows) ;
            dataSet.Merge( ViajesEnPlanificacionSet) ;
            return 0 ;
         }
      }
                           ...
                           int maxRows )
      {
         ...
         while ( ( cmViajeSelect2.HasMoreRows ) && ( ( loadedRows != maxRows ) ) )
         {
            ...
            m_ViajeDescargas = dsDefault.Db.GetInt32(ViajeSelect2, 18, ref m__ViajeDescargasIsNull) ;
            m_ViajeMeGustas = dsDefault.Db.GetInt32(ViajeSelect2, 19, ref m__ViajeMeGustasIsNull) ;
            m_ViajeParentID = dsDefault.Db.GetInt64(ViajeSelect2, 20, ref m__ViajeParentIDIsNull) ;
            m_ViajePrivado = dsDefault.Db.GetString(ViajeSelect2, 21, ref m__ViajePrivadoIsNull) ;
            rowViaje = ViajesEnPlanificacionSet.Viaje.NewViajeRow() ;
      ...
      private ViajesEnPlanificacionDataSet.ViajeRow rowViaje ;
      private void AddRowViaje( )
      {
         ViajesEnPlanificacionSet.Viaje.AddViajeRow( rowViaje) ;
         rowViaje.AcceptChanges( ) ;
      }

      ///  <summary>
      ///   Gets or sets the filter used by  ViajesEnPlanificacion DataProvider classes to retrieve
      ///    data.
      ///  </summary>
      ...
      private static String[] attributeNames = new String[]  {"TM1.[ViajeID]", "TM1.[UsuarioID]", "TM1.[ViajeNombre]", "TM1.[FechaSalidaProgramada]", "TM1.[FechaLlegadaProgramada]", "TM1.[FechaSalidaEfectiva]", "TM1.[FechaLlegadaEfectiva]", "TM1.[LugarPartida]", "TM1.[Lugarllegada]", "TM1.[LongitudPartida]", "TM1.[LatitudPartida]", "TM1.[LongitudLegada]", "TM1.[LatitudLlegada]", "TM1.[kmTotalesEstimado]", "TM1.[MotocilcetaMarca]", "TM1.[MotociletaModelo]", "TM1.[ViajeImagen]", "TM1.[ViajeEstado]", "TM1.[ViajeDescargas]", "TM1.[ViajeMeGustas]", "TM1.[ViajeParentID]", "TM1.[ViajePrivado]"} ;
   ...
   public class ViajesEnPlanificacionDataReader : System.IDisposable
   {
      public ViajesEnPlanificacionDataReader( )
      {
         Init_order_Viaje( ) ;
         orderString = GetOrderString( this.Order, true) ;
         reverseOrderString = GetOrderString( this.Order, false) ;
      ...
      private IDbTransaction daCurrentTransaction ;
      ///  <summary>
      ///   Gets or sets the Transaction object to be used  by  ViajesEnPlanificacionDataReaderDeklarit
