...
//               File: ViajesEliminadosDataAdapter
...
namespace Raiderplan1 {
   ...
   public partial class ViajesEliminadosDataAdapter : System.Data.IDataAdapter, IViajesEliminadosDataAdapter
   {
      private ViajesEliminadosDataSet ViajesEliminadosSet ;
      public ViajesEliminadosDataAdapter( )
      {
      ...
      ///  <summary>
      ///   Gets or sets the Transaction object to be used  by  ViajesEliminadosDataAdapterclasses
      ...
      public virtual int Fill( ViajesEliminadosDataSet dataSet ,
                               int usuarioID )
      {
         this.Initialize( ) ;
         connDefault = dsDefault.GetReadWriteConnection( daCurrentTransaction) ;
         ViajesEliminadosSet = dataSet ;
      ...
      public virtual int FillPage( ViajesEliminadosDataSet dataSet ,
                                   int usuarioID ,
                                   int startRow ,
                                   int maxRows )
      {
      ...
      private int GetInternalRecordCount( int usuarioID )
      {
         ...
         m_WhereString = " WHERE (@UsuarioID = [UsuarioID]) AND ([ViajeEstado] = 'Z')" ;
      ...
      {
         ViajesEliminadosSet = dataSet as ViajesEliminadosDataSet ;
         if ( ( ViajesEliminadosSet != null ) )
         {
            return Fill( ViajesEliminadosSet) ;
         }
         else
         {
            ViajesEliminadosSet = new ViajesEliminadosDataSet() ;
            Fill( ViajesEliminadosSet) ;
            dataSet.Merge( ViajesEliminadosSet) ;
            return 0 ;
         }
      }
                                   ...
                                   int maxRows )
      {
         ...
         if ( ( ViajesEliminadosSet != null ) )
         {
            return FillPage( ViajesEliminadosSet, startRow, maxRows) ;
         }
         else
         {
            ViajesEliminadosSet = new ViajesEliminadosDataSet() ;
            FillPage( ViajesEliminadosSet, startRow, maxRows) ;
            dataSet.Merge( ViajesEliminadosSet) ;
            return 0 ;
         }
      }
                           ...
                           int maxRows )
      {
         ...
         while ( ( cmViajeSelect2.HasMoreRows ) && ( ( loadedRows != maxRows ) ) )
         {
            ...
            m_ViajeMeGustas = dsDefault.Db.GetInt32(ViajeSelect2, 18, ref m__ViajeMeGustasIsNull) ;
            m_ViajeDescargas = dsDefault.Db.GetInt32(ViajeSelect2, 19, ref m__ViajeDescargasIsNull) ;
            m_ViajePrivado = dsDefault.Db.GetString(ViajeSelect2, 20, ref m__ViajePrivadoIsNull) ;
            m_ViajeParentID = dsDefault.Db.GetInt64(ViajeSelect2, 21, ref m__ViajeParentIDIsNull) ;
            rowViaje = ViajesEliminadosSet.Viaje.NewViajeRow() ;
      ...
      private ViajesEliminadosDataSet.ViajeRow rowViaje ;
      private void AddRowViaje( )
      {
         ViajesEliminadosSet.Viaje.AddViajeRow( rowViaje) ;
         rowViaje.AcceptChanges( ) ;
      }

      ///  <summary>
      ///   Gets or sets the filter used by  ViajesEliminados DataProvider classes to retrieve
      ///    data.
      ///  </summary>
      ...
      private static String[] attributeNames = new String[]  {"TM1.[ViajeID]", "TM1.[UsuarioID]", "TM1.[ViajeNombre]", "TM1.[FechaSalidaProgramada]", "TM1.[FechaLlegadaProgramada]", "TM1.[FechaSalidaEfectiva]", "TM1.[FechaLlegadaEfectiva]", "TM1.[LugarPartida]", "TM1.[Lugarllegada]", "TM1.[LongitudPartida]", "TM1.[LatitudPartida]", "TM1.[LongitudLegada]", "TM1.[LatitudLlegada]", "TM1.[kmTotalesEstimado]", "TM1.[MotocilcetaMarca]", "TM1.[MotociletaModelo]", "TM1.[ViajeImagen]", "TM1.[ViajeEstado]", "TM1.[ViajeMeGustas]", "TM1.[ViajeDescargas]", "TM1.[ViajePrivado]", "TM1.[ViajeParentID]"} ;
   ...
   public class ViajesEliminadosDataReader : System.IDisposable
   {
      public ViajesEliminadosDataReader( )
      {
         Init_order_Viaje( ) ;
         orderString = GetOrderString( this.Order, true) ;
         reverseOrderString = GetOrderString( this.Order, false) ;
      ...
      private IDbTransaction daCurrentTransaction ;
      ///  <summary>
      ///   Gets or sets the Transaction object to be used  by  ViajesEliminadosDataReaderDeklarit
