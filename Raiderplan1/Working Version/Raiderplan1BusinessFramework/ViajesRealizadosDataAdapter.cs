...
//               File: ViajesRealizadosDataAdapter
...
namespace Raiderplan1 {
   ...
   public partial class ViajesRealizadosDataAdapter : System.Data.IDataAdapter, IViajesRealizadosDataAdapter
   {
      private ViajesRealizadosDataSet ViajesRealizadosSet ;
      public ViajesRealizadosDataAdapter( )
      {
      ...
      ///  <summary>
      ///   Gets or sets the Transaction object to be used  by  ViajesRealizadosDataAdapterclasses
      ...
      public virtual int Fill( ViajesRealizadosDataSet dataSet ,
                               int usuarioID )
      {
         this.Initialize( ) ;
         connDefault = dsDefault.GetReadWriteConnection( daCurrentTransaction) ;
         ViajesRealizadosSet = dataSet ;
      ...
      public virtual int FillPage( ViajesRealizadosDataSet dataSet ,
                                   int usuarioID ,
                                   int startRow ,
                                   int maxRows )
      {
      ...
      private int GetInternalRecordCount( int usuarioID )
      {
         ...
         m_WhereString = " WHERE (@UsuarioID = [UsuarioID]) AND ([ViajeEstado] = 'R')" ;
      ...
      {
         ViajesRealizadosSet = dataSet as ViajesRealizadosDataSet ;
         if ( ( ViajesRealizadosSet != null ) )
         {
            return Fill( ViajesRealizadosSet) ;
         }
         else
         {
            ViajesRealizadosSet = new ViajesRealizadosDataSet() ;
            Fill( ViajesRealizadosSet) ;
            dataSet.Merge( ViajesRealizadosSet) ;
            return 0 ;
         }
      }
                                   ...
                                   int maxRows )
      {
         ...
         if ( ( ViajesRealizadosSet != null ) )
         {
            return FillPage( ViajesRealizadosSet, startRow, maxRows) ;
         }
         else
         {
            ViajesRealizadosSet = new ViajesRealizadosDataSet() ;
            FillPage( ViajesRealizadosSet, startRow, maxRows) ;
            dataSet.Merge( ViajesRealizadosSet) ;
            return 0 ;
         }
      }
                           ...
                           int maxRows )
      {
         ...
         while ( ( cmViajeSelect2.HasMoreRows ) && ( ( loadedRows != maxRows ) ) )
         {
            ...
            rowViaje = ViajesRealizadosSet.Viaje.NewViajeRow() ;
      ...
      private ViajesRealizadosDataSet.ViajeRow rowViaje ;
      private void AddRowViaje( )
      {
         ViajesRealizadosSet.Viaje.AddViajeRow( rowViaje) ;
         rowViaje.AcceptChanges( ) ;
      }

      ///  <summary>
      ///   Gets or sets the filter used by  ViajesRealizados DataProvider classes to retrieve
      ///    data.
      ///  </summary>
      ...
      private static String[] attributeNames = new String[]  {"TM1.[ViajeID]", "TM1.[UsuarioID]", "TM1.[ViajeNombre]", "TM1.[FechaSalidaProgramada]", "TM1.[FechaLlegadaProgramada]", "TM1.[FechaSalidaEfectiva]", "TM1.[FechaLlegadaEfectiva]", "TM1.[LugarPartida]", "TM1.[Lugarllegada]", "TM1.[LongitudPartida]", "TM1.[LatitudPartida]", "TM1.[LongitudLegada]", "TM1.[LatitudLlegada]", "TM1.[kmTotalesEstimado]", "TM1.[MotocilcetaMarca]", "TM1.[MotociletaModelo]", "TM1.[ViajeImagen]", "TM1.[ViajeEstado]", "TM1.[ViajeParentID]", "TM1.[ViajeMeGustas]", "TM1.[ViajeDescargas]", "TM1.[ViajePrivado]"} ;
   ...
   public class ViajesRealizadosDataReader : System.IDisposable
   {
      public ViajesRealizadosDataReader( )
      {
         Init_order_Viaje( ) ;
         orderString = GetOrderString( this.Order, true) ;
         reverseOrderString = GetOrderString( this.Order, false) ;
      ...
      private IDbTransaction daCurrentTransaction ;
      ///  <summary>
      ///   Gets or sets the Transaction object to be used  by  ViajesRealizadosDataReaderDeklarit
